...
void CliqueRouter::init(Vec<shared_ptr<Node>>& nodes) {
...
void CliqueRouter::init_history(Vec<shared_ptr<Node>>& nodes) {
    history = {};
    update_history(nodes);
}

void CliqueRouter::update_history(Vec<shared_ptr<Node>>& nodes) {
    TimePoint tp;
    for (auto& node : nodes) {
        auto raw = node.get();
...
void CliqueRouter::step2(Vec<shared_ptr<Node>>& nodes) {
...
void CliqueRouter::step3(Vec<shared_ptr<Node>>& nodes) {
...
void CliqueRouter::check_step3_round2_result(Vec<shared_ptr<Node>>& nodes) {
    for (auto& node : nodes) {
...
void CliqueRouter::move_messages_between_sets(Vec<shared_ptr<Node>>& nodes) {
...
void CliqueRouter::move_messages_within_sets(Vec<shared_ptr<Node>>& nodes) {
...
void CliqueRouter::check_step_2_precondition(Vec<shared_ptr<Node>>& nodes) {
...
void CliqueRouter::check_step_3_precondition(Vec<shared_ptr<Node>>& nodes) {
...
void CliqueRouter::check_step_4_precondition(Vec<shared_ptr<Node>>& nodes) {
    for (auto& node : nodes) {
...
void CliqueRouter::check_step_5_precondition(Vec<shared_ptr<Node>>& nodes) {
    for (auto& node : nodes) {
...
void CliqueRouter::route(Vec<shared_ptr<Node>>& nodes) {
    init(nodes);
    init_history(nodes);
    step2(nodes);
    step3(nodes);
...
vector<TimePoint>& CliqueRouter::get_history() {
    return history;
}
